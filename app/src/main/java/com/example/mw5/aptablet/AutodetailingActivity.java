...
public class AutodetailingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_autodetailing);
        ...
        this.taskType = "autodetailing";

        //initialize listView
        lV = (ListView) findViewById(R.id.ad_list);

        lV.setAdapter(adapter);
        new AutodetailingActivity.AsyncGetTasks().execute(token); //token?
        ...
        lV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapter, View view, int position, long id) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    builder = new AlertDialog.Builder(AutodetailingActivity.this, android.R.style.Theme_Material_Dialog_Alert);
                } else {
                    builder = new AlertDialog.Builder(AutodetailingActivity.this);
                }
                if (name.indexOf("nowe") > -1) {
                    builder.setTitle("Potwierdzenie")
                            ...
                            .setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    new AutodetailingActivity.AsyncServeTask().execute(token, regNum, taskType, "begin", userName); //token?
                                    listItems.clear();
                                    new AutodetailingActivity.AsyncGetTasks().execute(token); //token?
                                }
                    ...
                    builder.setTitle("Potwierdzenie")
                            ...
                            .setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    new AutodetailingActivity.AsyncServeTask().execute(token, regNum, taskType, "end", userName); //token?
                                    listItems.clear();
                                    new AutodetailingActivity.AsyncGetTasks().execute(token); //token?
                                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            Intent intent = new Intent(AutodetailingActivity.this, LoginActivity.class);
            startActivity(intent);
            AutodetailingActivity.this.finish();
            return true;
        }
    ...
    private class AsyncGetTasks extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(AutodetailingActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                url = new URL(configProvider.getApiUrl()+configProvider.getGetAutodetailingTasksApi());
        ...
        protected void onPostExecute(String result) {
            ...
            if (!result.isEmpty() && !result.equalsIgnoreCase("false")) {
                ...
                Toast.makeText(AutodetailingActivity.this, "Problem z połączeniem z bazą danych", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private class AsyncServeTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("true")) {
                Toast.makeText(AutodetailingActivity.this, "Zmieniono status zlecenia", Toast.LENGTH_LONG).show();
                Log.d(TAG, result);//debug
